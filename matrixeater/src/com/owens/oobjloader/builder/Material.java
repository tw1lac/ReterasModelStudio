...
public class Material {
    ...
    public final ReflectivityTransmiss ka = new ReflectivityTransmiss();
    public final ReflectivityTransmiss kd = new ReflectivityTransmiss();
    public final ReflectivityTransmiss ks = new ReflectivityTransmiss();
    public final ReflectivityTransmiss tf = new ReflectivityTransmiss();
