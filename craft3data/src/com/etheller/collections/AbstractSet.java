...
/**
 * This class provides a skeletal implementation of the <tt>Set</tt> interface
 ...
 * obey the additional constraints imposed by the <tt>Set</tt> interface (for
 * instance, the add method must not permit addition of multiple instances of an
 * object to a set).
 * <p>
 *
 * Note that this class does not override any of the implementations from the
 * <tt>AbstractCollection</tt> class. It merely adds implementations for
