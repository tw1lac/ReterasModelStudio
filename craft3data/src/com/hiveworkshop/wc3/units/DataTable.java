...
public class DataTable implements ObjectData {
	...
	public void loadDefaults() {
		...
		// get("h02Y").setField("Name", "Shrine of the Eather");
		// get("h02H").setField("Name", "Eathergate");
		// get("h02G").setField("Name", "Vault of the Eather");
		// get("h02V").setField("Name", "Eatherstorm Tower");
