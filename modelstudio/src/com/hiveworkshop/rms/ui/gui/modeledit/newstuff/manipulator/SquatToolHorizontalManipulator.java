...
public class SquatToolHorizontalManipulator extends AbstractManipulator {
	private final ModelEditor modelEditor;
	private final SelectionView selectionView;
	private GenericRotateAction rotationAction;

	public SquatToolHorizontalManipulator(final ModelEditor modelEditor, final SelectionView selectionView) {
	...
	protected void onStart(final Double mouseStart, final byte dim1, final byte dim2) {
		...
		rotationAction = modelEditor.beginSquatTool(center.x, center.y, center.z, dim1,
	...
	private double computeRotateRadians(final Double startingClick, final Double endingClick, final Vec3 center,
		...
		return (endingClick.x - startingClick.x) / radius;
	}
