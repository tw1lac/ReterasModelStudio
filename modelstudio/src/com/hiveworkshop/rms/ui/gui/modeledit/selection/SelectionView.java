...
public interface SelectionView {
	...
	Vec3 getUVCenter(int tvertexLayerId);

	Collection<? extends Vec3> getSelectedTVertices(int tvertexLayerId);

	double getCircumscribedSphereRadius(Vec3 center, int tvertexLayerId);
